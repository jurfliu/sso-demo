package com.bonc.ljf.sso.demo.tmall.intercepter;

import com.bonc.ljf.sso.demo.tmall.util.HttpUtil;
...
/**
 * @ClassName: SsoTmallInterceptor
 * @Description: TODO
 * @Author: liujianfu
 * @Date: 2020/08/16 18:21:44
 * @Version: V1.0
 **/
public class SsoTmallInterceptor implements HandlerInterceptor {
    // false 拦截    true 通行
    /**
     * @author liujianfu
     * @description  做预处理
